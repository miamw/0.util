...
%default data_dir 'hdfs://dilithiumred-nn1.red.ygrid.yahoo.com:8020/projects/jaguar/prod/feeds/post_tp_annotated_gd2_click/5m'
...
TRIM = LOAD '$data_dir/data/$dat$hr*' USING com.yahoo.yzip.hadoop.pig.YZipPigSchemaStorage('$data_dir/schema/$ts_schema/post_tp_annotated_gd2_click.schema');
TRIM = FOREACH TRIM GENERATE
	...
	(tpcsnrt_valid IS NULL?1:tpcsnrt_valid) AS valid,
